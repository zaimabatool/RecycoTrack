                ...
                <div className="fixed inset-0 bg-secondary/80 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
                    <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-md p-8 animate-in fade-in zoom-in duration-300 relative">
                        ...
                        <div className="text-center mb-8">
                            ...
                            <h2 className="text-3xl font-black text-secondary tracking-tight">{editMode ? 'Edit Profile' : 'New Recruit'}</h2>
                            <p className="text-gray-500 font-medium">{editMode ? 'Update account details.' : 'Onboard a new collection specialist.'}</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-1">Phone (Optional)</label>
                                <div className="relative">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-[11px] font-black text-gray-400 uppercase tracking-widest ml-1">{editMode ? 'New Password (Optional)' : 'Temporary Password'}</label>
                                <div className="relative">
                            ...
                            >
                                {loading ? (editMode ? 'Updating...' : 'Onboarding...') : (editMode ? 'Save Changes' : 'Confirm & Create Account')}
                            </button>
                        </form>
                    </div>
                </div>
